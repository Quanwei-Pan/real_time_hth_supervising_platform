proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: aes_ip_0, and set properties
	set aes_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:aes_ip:1.0 aes_ip_0]
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI_LITE] [get_bd_intf_pins aes_ip_0/S00_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/M_AXI_LITE_ACLK] [get_bd_pins aes_ip_0/S00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/M_AXI_LITE_ARESETN] [get_bd_pins aes_ip_0/S00_AXI_ARESETN]
	...
	# Create interface connections
	connect_bd_intf_net -intf_net slave_0_s_axis [get_bd_intf_pins aes_ip_0/M00_AXIS] [get_bd_intf_pins slave_0/S_AXIS]
	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins aes_ip_0/M00_AXIS_ACLK] [get_bd_pins slave_0/S_AXIS_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins aes_ip_0/M00_AXIS_ARESETN] [get_bd_pins slave_0/S_AXIS_ARESETN]
	...
	# Create interface connections
	connect_bd_intf_net -intf_net master_1_m_axis [get_bd_intf_pins aes_ip_0/S00_AXIS] [get_bd_intf_pins master_1/M_AXIS]
	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins aes_ip_0/S00_AXIS_ACLK] [get_bd_pins master_1/M_AXIS_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins aes_ip_0/S00_AXIS_ARESETN] [get_bd_pins master_1/M_AXIS_ARESETN]
	...
	set offset_file "${bd_path}/aes_ip_v1_0_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef aes_ip_v1_0_tb_include_vh_"
	puts $fp "`define aes_ip_v1_0_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:aes_ip:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/aes_ip_v1_0_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "aes_ip_v1_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 aes_ip_v1_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top aes_ip_v1_0_tb [get_filesets sim_1]
